...
int nicolas4 = 88;
int nicolas5 = 85;
decimal nicolasAverage = (nicolas1 + nicolas2 + nicolas3 + nicolas4 + nicolas5) / (decimal)currentAssignments;
...
int zahirah4 = 85;
int zahirah5 = 79;
decimal zahirahAverage = (zahirah1 + zahirah2 + zahirah3 + zahirah4 + zahirah5) / (decimal)currentAssignments;
...
int jeong4 = 100;
int jeong5 = 97;
decimal jeongAverage = (jeong1 + jeong2 + jeong3 + jeong4 + jeong5) / (decimal)currentAssignments;
